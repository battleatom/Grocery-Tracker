...
data.meta.updated_at=now;data.meta.automation={last_run:now,matched:changed,schedule:'every 6 hours',policy:'retain last verified value when a source cannot be parsed'};
